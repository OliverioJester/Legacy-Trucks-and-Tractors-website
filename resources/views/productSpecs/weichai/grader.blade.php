...
@section('title', 'Grader || The Legacy Trucks and Tractors')
@section('meta_description', 'The WG150 Motor Grader is a high-performance, versatile machine designed for precision grading, road maintenance, and construction projects, offering reliable power, advanced control, and durability for demanding tasks.')
