...
@section('title', 'Bulldozer || The Legacy Trucks and Tractors')
@section('meta_description', 'The Bulldozer WSD320 is a high-performance, heavy-duty machine designed for large-scale earthmoving and construction projects, offering robust power, durability, and advanced control features to handle the toughest terrains and tasks efficiently.')
