...
@section('title', 'Wheel Loader || The Legacy Trucks and Tractors')
@section('meta_description', 'The Wheel Loader WL880K-HST is a high-performance machine designed for heavy-duty tasks, featuring advanced hydraulic systems, powerful lifting capabilities, and exceptional stability, making it ideal for construction, mining, and other demanding applications.')
