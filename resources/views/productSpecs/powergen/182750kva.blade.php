...
@section('title', 'Powergen 18-2750-KVA || The Legacy Trucks and Tractors')
@section('meta_description', 'The powergen 18-2750 KVA generator is a reliable and efficient power generator designed to deliver consistent electrical output, equipped with a robust engine and advanced technology, making it suitable for a wide range of industrial and commercial applications.')
