...
@section('title', 'FTR || The Legacy Trucks and Tractors')
@section('meta_description', 'The Kingling Isuzu FTR is a versatile medium-duty 4×2 truck designed for efficient urban and regional transport. It offers reliable performance, fuel efficiency, and a durable build, making it well-suited for delivery, cargo hauling, and a wide range of commercial applications.')
