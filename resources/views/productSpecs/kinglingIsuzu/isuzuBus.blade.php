...
@section('title', 'Isuzu Bus || The Legacy Trucks and Tractors')
@section('meta_description', 'The Kingling Isuzu Bus is a versatile bus designed for efficient passenger transportation, offering a comfortable ride and durable performance.')
