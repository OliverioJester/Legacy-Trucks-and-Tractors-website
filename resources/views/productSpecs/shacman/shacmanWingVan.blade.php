...
@section('title', 'Shacman Wing Van || The Legacy Trucks and Tractors')
@section('meta_description', 'The Shacman Wing Van is a heavy-duty vehicle designed for efficient transportation of various goods, offering a spacious cargo area and reliable performance. Optimize your cargo transportation needs with the Shacman Wing Van, the ideal solution for efficient and secure delivery.')
