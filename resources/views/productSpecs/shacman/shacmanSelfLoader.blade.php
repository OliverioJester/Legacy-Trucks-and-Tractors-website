...
@section('title', 'Shacman Self Loader || The Legacy Trucks and Tractors')
@section('meta_description', 'The Shacman Self Loader is a heavy-duty recovery and transport truck designed for efficient vehicle loading and hauling, equipped with a powerful hydraulic system, durable chassis, and reliable performance suited for towing, roadside assistance, and equipment transport operations.')
