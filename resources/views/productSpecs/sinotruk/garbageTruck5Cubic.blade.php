...
@section('title', 'Garbage Truck 5 Cubic || The Legacy Trucks and Tractors')
@section('meta_description', 'The Sinotruck 5 Cubic Garbage Truck is a durable and efficient waste management solution, ideal for urban and commercial use. Its compact design allows for easy maneuverability in tight spaces, while the sturdy build ensures reliable performance. Equipped with an optimized hydraulic system, it provides smooth and hassle-free operation, making waste collection more efficient and convenient.')
