...
@section('title', 'The Forland Dump Truck 3CBM || The Legacy Trucks and Tractors')
@section('meta_description', 'The Forland Dump Truck 3CBM is a light to medium-duty truck designed for transporting and unloading materials such as sand, gravel, and construction debris, featuring a 3-cubic-meter dump body.')
