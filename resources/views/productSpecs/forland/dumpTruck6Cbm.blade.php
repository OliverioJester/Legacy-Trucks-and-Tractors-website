...
@section('title', 'Dump Truck 6 CBM || The Legacy Trucks and Tractors')
@section('meta_description', 'The Forland Dump Truck 6 CBM is a heavy-duty vehicle designed for construction and material transport, featuring a 6-cubic-meter dump body for efficient hauling of sand, gravel, and other bulk materials.')
